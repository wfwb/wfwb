	...
	<div class="row" style="height: 400px; background-image: url(../wfwb/assets/img/books.png); background-position: center center; background-repeat: no-repeat; background-size: cover; margin: 0 0 0 0;">
			...
			<div class="row" style="margin: 50px 0 20px 0;">
				<a href="#" style="color: #252120;">
					<div class="col-md-3" style="text-align: center; line-height: 10px;">
						...
						<p style="font-size: 15px;">ลัลลาบาย</p>
						<p>230 บาท ส่วนลด 15%</p>
					</div>
				</a>
				<!-- <a href="#" style="color: #252120;">
					<div class="col-md-3" style="text-align: center; line-height: 10px;">
	...
	<div class="row" style="height: auto; margin: 20px 0 0 0;">
		<div class="container">
			...
			<!-- </div> -->
			<!-- <hr style="border-top: 1px solid #221f20;"> -->
			<h1 style="margin-left: 50px;">หนังสือทั้งหมด</h1>
			<hr style="border-top: 1px solid #f2cd34;">
				...
				<div class="row" style="margin: 50px 0 50px 0;">
					...
					<a href="#">
						<div class="col-md-3" style="text-align: center;">
							...
							<p style="font-size: 15px;">อยุทธ์</p>
							<p>360 บาท ส่วนลด 15%</p>
						</div>
					</a>
					<a href="#">
						<div class="col-md-3" style="text-align: center;">
							...
							<p style="font-size: 15px;">ดวงตะวัน</p>
							<p>320 บาท ส่วนลด 15%</p>
						</div>
					</a>
					<a href="#">
						<div class="col-md-3" style="text-align: center;">
							...
							<p style="font-size: 15px;">ชลนิล</p>
							<p>320 บาท ส่วนลด 15%</p>
						</div>
					</a>
				</div>
				...
				<div class="row" style="margin: 50px 0 20px 0;">
					...
					<a href="#">
						<div class="col-md-3" style="text-align: center;">
							...
							<h4 style="font-weight: bold;">ต้องฤทธิ์รัก</h4>
							<p style="font-size: 15px;">อุมาริการ์</p>
							<p>280 บาท ส่วนลด 15%</p>
						</div>
					</a>
				</div>
				<!-- <hr> -->
